...
- [Instruction Set Matrix](architecture/instruction-set.md)
- [Memory Map](architecture/memory-map.md)
- [UART Monitor Reference](architecture/uart-monitor.md)
- [Viva Preparation](architecture/viva_prep.md)

## Verification
- [Test Plan](verification/test-plan.md)

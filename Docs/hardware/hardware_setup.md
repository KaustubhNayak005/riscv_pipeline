...
6. Check timing summary: WNS must be positive (Baseline `sys_clk` WNS is +5.447 ns, `pll_clk` is +25.005 ns)
...
See `Docs/architecture/uart_monitor_ref.md` for the full protocol specification.

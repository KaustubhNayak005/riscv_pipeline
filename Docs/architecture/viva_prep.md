...
- How many RV32I instructions are supported? (37 implemented + 6 intentionally unsupported)
...
> Refer: [architecture.md](./architecture.md) — Implemented Proof Points, Top-Level Structure; [session_2026-06-02_2345_kaustubh.md](../updates/session_2026-06-02_2345_kaustubh.md) — Vivado Build Results
...
|----------|------|-----------|---|
| LUTs | 3263 | 53200 | 6.13% |
| Registers | 1737 | 106400 | 1.63% |
| BRAM | 1 | 140 | 0.71% |
| DSP | 0 | 220 | 0.00% |

- What does WNS (Worst Negative Slack) mean? (+5.447 ns = timing met)
...
> Refer: [roadmap.md](../planning/roadmap.md) — Verification Evidence; [architecture.md](./architecture.md) — Implemented Proof Points
...
> Refer: [roadmap.md](../planning/roadmap.md) — Phase 1; [architecture.md](./architecture.md) — Assembly/program flow
...
> Refer: [roadmap.md](../planning/roadmap.md) — Full roadmap; [simd_unit.dot](../diagrams/simd_unit.dot); [multicore.dot](../diagrams/multicore.dot)
...
- What would a UART monitor do? (load, run, reset commands over serial)

### Phase 5: Traps, Exceptions, and Timer Interrupts
- What trap CSRs are planned? (`mepc`, `mcause`, `mtvec`, `mstatus`)
- What is a trap handler? What is the trap entry/return flow?
- What is `MRET`?

### Phase 6: RV32M Extension
- What instructions does RV32M add? (`MUL`, `MULH`, `DIV`, `REM`, etc.)
- Single-cycle vs multi-cycle multiply — trade-offs

### Phase 7: Running C Programs
- What is needed to run C on bare metal? (linker script, startup code, stack, UART putchar)

### Phase 8: Branch Prediction
- What prediction schemes are possible? (static not-taken, backward-taken/forward-not-taken, 2-bit predictor)

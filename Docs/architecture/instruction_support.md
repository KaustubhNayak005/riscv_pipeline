...
| CSRRW       | I      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 5 |
| CSRRS       | I      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 5 |
| CSRRC       | I      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 5 |
| CSRRWI      | I      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 5 |
| CSRRSI      | I      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 5 |
| CSRRCI      | I      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 5 |

### M Extension — Multiply / Divide
| Instruction | Format | Implemented | Sim Tested | FPGA Verified | Notes |
|-------------|--------|:-----------:|:----------:|:-------------:|-------|
| MUL         | R      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 6 |
| MULH        | R      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 6 |
| MULHU       | R      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 6 |
| MULHSU      | R      | ❌ No        | ❌ No       | ❌ No         | Deferred to Phase 6 |

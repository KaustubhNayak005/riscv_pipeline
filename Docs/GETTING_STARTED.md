...
5. **Before exiting**, completes a mandatory 6-item checklist:
   ...
   - Updates `Docs/planning/status.md`
...
5. **Documentation Update (MANDATORY):** Before the AI exits:
   ...
   - Updates `Docs/planning/status.md` with completed tasks
...
- Are `Docs/ai_context.md` and `Docs/planning/status.md` fresher than the last session log?
...
| Understand the design | Read `Docs/architecture/architecture.md` |

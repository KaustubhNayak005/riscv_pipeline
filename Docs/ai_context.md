...
2. **Read** `Docs/planning/status.md`, `Docs/architecture/architecture.md`, `Docs/planning/roadmap.md`.
...
3. **Keep `Docs/planning/status.md` Current:** Append completed tasks to "Recently Completed" and update any tables/trackers if phase progress was made.
...
- **`Docs/planning/status.md`**: What was updated.
...
- [`Docs/architecture/architecture.md`](./architecture/architecture.md): Full technical architecture, memory map, and instruction support table.
- [`Docs/planning/roadmap.md`](./planning/roadmap.md): Long-term plan and phase definitions.
- [`Docs/planning/status.md`](./planning/status.md): Live tracker of phase completion and remaining work.
- [`Docs/architecture/viva_prep.md`](./architecture/viva_prep.md): General Q&A and knowledge base for the project design.
- [`Docs/architecture/uart_monitor_ref.md`](./architecture/uart_monitor_ref.md): UART monitor command reference and protocol specification.
...
| `Docs/architecture/uart_monitor_ref.md` | UART monitor command reference and protocol specification. | ✅ Live | 2026-06-04 |
| `Docs/architecture/instruction_support.md` | Instruction support matrix. Tracks implemented/tested/FPGA-verified status per RV32I instruction. | ✅ Complete | 2026-06-03 |
| `Docs/verification/verification.md` | Test status tracker. One entry per test with PASS/FAIL/TODO status and last-run date. | ✅ Complete | 2026-06-03 |
...
| `Docs/hardware/hardware_setup.md` | Full hardware setup and build guide. Board, pins, UART, build steps, test procedure. | ✅ Complete | 2026-06-03 |
| `Docs/planning/known_issues.md` | Living issue tracker. Bugs, limitations, technical debt, future investigations. | ✅ Complete | 2026-06-04 |
...
- **2026-06-03**: Created documentation system: instruction_support.md, verification.md, performance.md, ownership.md, hardware_setup.md, known_issues.md, DECISIONS/ directory with 001 ADR and 4 stubs.
